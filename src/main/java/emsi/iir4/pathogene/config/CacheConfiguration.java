...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, emsi.iir4.pathogene.domain.Classification.class.getName());
            createCache(cm, emsi.iir4.pathogene.domain.Compte.class.getName());
            createCache(cm, emsi.iir4.pathogene.domain.Detection.class.getName());
            createCache(cm, emsi.iir4.pathogene.domain.Image.class.getName());
            createCache(cm, emsi.iir4.pathogene.domain.Maladie.class.getName());
            createCache(cm, emsi.iir4.pathogene.domain.Maladie.class.getName() + ".detections");
            ...
            createCache(cm, emsi.iir4.pathogene.domain.Patient.class.getName() + ".detections");
            createCache(cm, emsi.iir4.pathogene.domain.RendezVous.class.getName());
            createCache(cm, emsi.iir4.pathogene.domain.Secretaire.class.getName());
