...
export default class JhiUserManagementEdit extends Vue {
  ...
  public save(): void {
    ...
    if (this.userAccount.id) {
      this.userManagementService()
        ...
        .then(res => {
          this.returnToList();
          this.$bvToast.toast(this.getMessageFromHeader(res).toString(), {
      ...
      if (!this.isAdmin()) this.userAccount.authorities = ['PATIENT'];
  ...
  private getMessageFromHeader(res: any): any {
    return this.$t(res.headers['x-pathogeneapp-alert'], {
